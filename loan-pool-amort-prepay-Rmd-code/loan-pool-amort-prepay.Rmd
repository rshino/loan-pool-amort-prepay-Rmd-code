...
library(kableExtra)
library(nortest)
knitr::opts_chunk$set(echo = FALSE,warning=FALSE,fig.width=6,fig.height=2.85,dpi=300)
...
```{r amortization,fig.cap='Scheduled Amortization'}
cpr.eg<-0
...
```{r small.pool.simulation.trials,results='asis',fig.cap='Small Pool Sim.',fig.keep='high'}
min.cutoff<-1
max.cutoff<-60 # only include prepay from month 1:max.cutoff
trials<-100
#
lc<-100
cat(sprintf("\n\n## %d Loans/Pool Statistics\n",lc))
