...
At the end of month 360 (for 30 year loan), we have:
...
\end{aligned}
$$
The variables for SMM~i~ and CPR~i~ used to this point have a term of 1 month; i.e., 
...
For this reason, it is common to measure prepayment
...
\end{aligned}
$$
The 12-month measure captures a full year is free from 
seasonal variation.

$$
\begin{aligned}
SMM_{12,i} &= \sqrt[12]{\frac{\sum_{k=i-11}^{i}p_{U,k}}{B_{A,i}+\sum_{k=i-11}^{i}p_{U,k}}}\\
\end{aligned}
$$
The term SMM measures are geometric averages expressed as 1-month equivalents, and can be converted to corresponding term CPR in the usual way.
...
The loan simulation case will most closely highlight measurement of 
...
The 12-month CPR is significantly more stable than the shorter term measures, as 
